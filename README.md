...
**Step-1:** Clone the LambdaTest’s [LT-appium-ruby-cucumber](https://github.com/LambdaTest/LT-appium-ruby-cucumber) and navigate to the code directory as shown below:
